...
```diff
- rpc.proto::MeyCoinRPCService::ChangeMembership (arg: MembershipChange, ret: MembershipChangeReply)
```

## 2.2.0 (March 3, 2020)

```diff
+ rpc.proto::MeyCoinRPCService::ExportAccountKeystore (arg: Personal, ret: SingleBytes)
+ rpc.proto::MeyCoinRPCService::keystore (type: SingleBytes, fieldNo: 4)
```
...
+ rpc.proto::MeyCoinRPCService::GetEnterpriseConfig (arg: EnterpriseConfigKey, ret: EnterpriseConfig)
+ rpc.proto::MeyCoinRPCService::GetConfChangeProgress (arg: SingleBytes, ret: ConfChangeProgress)
...
+ rpc.proto::MeyCoinRPCService::ChainStat (arg: Empty, ret: ChainStats)
+ rpc.proto::MeyCoinRPCService::ChangeMembership (arg: MembershipChange, ret: MembershipChangeReply)
...
- rpc.proto::MeyCoinRPCService::GetVotes (arg: SingleBytes, ret: VoteList)
+ rpc.proto::MeyCoinRPCService::GetVotes (arg: VoteParams, ret: VoteList)
+ rpc.proto::MeyCoinRPCService::GetAccountVotes (arg: AccountAddress, ret: AccountVoteInfo)
- rpc.proto::MeyCoinRPCService::GetStaking (arg: SingleBytes, ret: Staking)
+ rpc.proto::MeyCoinRPCService::GetStaking (arg: AccountAddress, ret: Staking)
+ rpc.proto::MeyCoinRPCService::GetServerInfo (arg: KeyParams, ret: ServerInfo)
+ rpc.proto::MeyCoinRPCService::GetConsensusInfo (arg: Empty, ret: ConsensusInfo)
...
- rpc.proto::MeyCoinRPCService::GetPeers (arg: Empty, ret: PeerList)
+ rpc.proto::MeyCoinRPCService::GetPeers (arg: PeersParams, ret: PeerList)
+ rpc.proto::MeyCoinRPCService::ListEventStream (arg: FilterInfo, ret: stream Event)
+ rpc.proto::MeyCoinRPCService::ListEvents (arg: FilterInfo, ret: EventList)
...
+ rpc.proto::MeyCoinRPCService::GetChainInfo (arg: Empty, ret: ChainInfo)
+ rpc.proto::MeyCoinRPCService::GetBlockMetadata (arg: SingleBytes, ret: BlockMetadata)
+ rpc.proto::MeyCoinRPCService::GetBlockBody (arg: BlockBodyParams, ret: BlockBodyPaged)
- rpc.proto::MeyCoinRPCService::GetStateAndProof (arg: AccountAndRoot, ret: StateProof)
+ rpc.proto::MeyCoinRPCService::GetStateAndProof (arg: AccountAndRoot, ret: AccountProof)
+ rpc.proto::ChainId
+ rpc.proto::ChainInfo
